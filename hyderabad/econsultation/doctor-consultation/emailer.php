...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("source"=>$utm_source,"phone" => $phone, "topic" => 'Doctor Consultation Call Back',"name"=>$name,"email"=> $email,"business"=>"Doctor Consultation","device"=>$device);                                                                    
...
$subject = "Doctor Consultation details from $name";
$message = "<html> <body>";
