...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div id="content" class="mobile-banner">
	  ...
	  <li><a href="#pack">Patient Stories</a></li>
	  ...
	  <div class="row" >
          <div class="col-md-6 col-xs-8 colpad">
           <div class="banncont">
		     <div class="head">Get expert physiotherapy care for your loved ones</div>
		     <div class="cont">Packages start at Rs.400 onwards</div>
		   </div>
          </div>
          ...
          <div class="login-panel panel panel-default">
					...
					<div class="phea">Get Physiotherapy @home</div>
 ...
 <div class="container">
		  ...
		  <div class="col-md-3 col-xs-6">
            <div class="service-container">
              ...
              <div class="service-content">
                <p>Physiotherapy services closely monitored by a specialist</p>
              </div>
            </div>
          </div>
