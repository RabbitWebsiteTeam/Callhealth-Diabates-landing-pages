...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("source"=>$utm_source,"phone" => $phone, "topic" => 'Physiotherapy Call Back',"name"=>$name,"email"=> $email,"business"=>"Physiotherapy","device"=>$device);                                                                    
...
$subject = "Physiotherapy details from $name";
$message = "<html> <body>";
