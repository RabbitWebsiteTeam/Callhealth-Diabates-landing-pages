    ...
    <div id="content" class="mobile-banner2">
	  ...
	  <div class="row" >
          <div class="col-md-6 col-xs-8 colpad">
           <div class="banncont">
		     <div class="head">Get medicines at no minimum order value</div>
		     <div class="cont">Get discounts up to 30%</div>
		   </div>
          </div>
          ...
          <div class="login-panel panel panel-default">
					...
					<div class="phea">Get your monthly medicine refil @home.</div>
