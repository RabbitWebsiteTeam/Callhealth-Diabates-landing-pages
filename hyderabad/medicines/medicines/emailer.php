...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("source"=>$utm_source,"phone" => $phone, "topic" => 'Medicines Adwords Call Back',"name"=>$name,"email"=> $email,"business"=>"Medicines","device"=>$device);                                                                    
...
$subject = "Medicines details from $name";
$message = "<html> <body>";
