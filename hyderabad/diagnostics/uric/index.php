...
<!-- Google Tag Manager -->
  ...
  <!-- End Google Tag Manager (noscript) -->
    ...
    </div> <form role="form" id="indexFrm" name="callhealth" action="emailer.php" method="post">
                            <fieldset>
...
<div class="col-xs-12 acont"> 
 ...
 <!--  <div class="panel panel-default clickable">
  ...
  <div class="col-xs-12 nor-pad">
    ...
    <div class="col-xs-12 acont"> 
    <ul>
    <li>In a patient with classic symptoms of high blood glucose or hyperglycaemia, a random plasma glucose of more than 200 mg/dL indicates diabetes in non-diabetic people. </li>
<li>In diabetics, RBS of more than 180 indicates uncontrolled blood glucose levels.</li>
<li>RBS of less than 70 mg/dl indicates low sugar levels in the body for which oral glucose should be taken immediately (any form of food that contains glucose may be used)</li>
       </ul>
    </div>
      </div>
    </div>
