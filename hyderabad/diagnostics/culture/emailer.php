...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("phone" => $phone, "topic" => 'Diagnostics Calture Call Back',"name"=>$name,"email"=> $email,"business"=>"Diagnostics Calture");                                                                    
...
$subject = "Diagnostics Calture details from $name";
$message = "<html> <body>";
