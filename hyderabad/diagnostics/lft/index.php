...
<div id="content1">
  ...
  <div class="panel panel-default clickable">
    ...
    <div id="collapseOne" class="panel-collapse collapse in">
	 ...
	 <?PHP echo $searchDescription; ?>   </div>
      </div>
    </div>
  </div>
  <div class="panel panel-default clickable">
...
<div class="col-xs-12 acont"> 
  ...
  <!-- <div class="panel panel-default clickable">
    ...
    <div id="collapseFour" class="panel-collapse collapse">
      <div class="panel-body">
	  <div class="col-xs-12 acont"> 
	 This test alone cannot pinpoint a problem. As abnormal values are found in a variety of conditions, further blood tests based on the symptoms helps in arriving at a diagnosis
	  </div>
      </div>
    </div>
  </div>   -->
