...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("phone" => $phone, "topic" => 'Diagnostics CBP Call Back',"name"=>$name,"email"=> $email,"business"=>"Diagnostics CBP");                                                                    
...
$source = "Diagnostics CBP details";
...
$subject = "Diagnostics CBP details from $name";
$message = "<html> <body>";
