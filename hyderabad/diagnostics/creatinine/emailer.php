...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("phone" => $phone, "topic" => 'Diagnostics Creatinine Call Back',"name"=>$name,"email"=> $email,"business"=>"Diagnostics creatinine");                                                                    
...
$source = "Diagnostics creatinine details";
...
$subject = "Diagnostics creatinine details from $name";
$message = "<html> <body>";
