...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("phone" => $phone, "topic" => 'Diagnostics VitaminD Call Back',"name"=>$name,"email"=> $email,"business"=>"Diagnostics VitaminD");                                                                    
...
$subject = "Diagnostics VitaminD details from $name";
$message = "<html> <body>";
