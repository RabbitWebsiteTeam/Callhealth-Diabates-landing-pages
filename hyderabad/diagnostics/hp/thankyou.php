...
// define vars
 ...
 if($status == 1){
    ...
    // name 
     $name = $data[8]->name;
    // what is this test
     $searchDescription = $data[8]->searchDescription;
    //why is it done
    $description = $data[8]->description;

    $description = nl2br($description);
    // Any instructions
     $servicePrecautions = $data[8]->servicePrecautions;

    //actual amount
     $grossAmount = $data[8]->grossAmount;
     // final amount
     $netAmount = $data[8]->netAmount;
      $metaTitle = $data[8]->metaTitle;
     //seoName
      $seoName = $data[8]->seoName;
        //metaDescription
      $metaDescription = $data[8]->metaDescription;
       $keywords = $data[8]->keywords; 
