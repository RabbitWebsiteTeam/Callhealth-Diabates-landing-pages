...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("phone" => $phone, "topic" => 'Diagnostics vit_b12 Call Back',"name"=>$name,"email"=> $email,"business"=>"Diagnostics vit_b12");                                                                    
...
$subject = "Diagnostics vit_b12 details from $name";
$message = "<html> <body>";
