...
<!-- Google Code for Spokes Diagnostics VIT - D3 Conversion Page -->
<script type="text/javascript">
/* <![CDATA[ */
var google_conversion_id = 825634145;
var google_conversion_label = "wXVVCM3ti3sQ4drYiQM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/825634145/?label=wXVVCM3ti3sQ4drYiQM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
...
<div id="myModal1" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
	  ...
	  <li>Complete Blood Count(CBC) or CBP</li>
	  <li>Complete Urine Examination (CUE) - Urine</li>
	  <li>Creatinine - Serum</li>
	  <li>Culture & Sensitivity urine</li>
	  <li>Erythrocyte Sedimentation Rate (ESR) - Whole Blood</li>
	  <li>Fasting Blood Glucose (FBS)</li>
	  <li>Glycosylated Hemoglobin (HBA1c) - Whole Blood</li>
	  <li>Hemoglobin   Hb - Whole Blood</li>
	  <li>Lipid Profile</li>
