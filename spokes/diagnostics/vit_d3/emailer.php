...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("phone" => $phone, "topic" => 'Diagnostics Vitamin_D3 Call Back',"name"=>$name,"email"=> $email,"business"=>"Diagnostics Vitamin_D3");                                                                    
...
$source = "Diagnostics Vitamin_D3";


 $to= toMails;  

$subject = "Diagnostics Vitamin_D3 from $name";
$message = "<html> <body>";
