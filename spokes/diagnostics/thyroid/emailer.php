...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("phone" => $phone, "topic" => 'Diagnostics Thyroid Call Back',"name"=>$name,"email"=> $email,"business"=>"Diagnostics Thyroid");                                                                    
...
$source = "Diagnostics Thyroid";


 $to= toMails;  

$subject = "Diagnostics Thyroid from $name";
$message = "<html> <body>";
