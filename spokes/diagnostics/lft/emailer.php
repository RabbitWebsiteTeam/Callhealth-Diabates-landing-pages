...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("phone" => $phone, "topic" => 'Diagnostics LFT Call Back',"name"=>$name,"email"=> $email,"business"=>"Diagnostics LFT");                                                                    
...
$source = "Diagnostics LFT";


 $to= toMails;  

$subject = "Diagnostics LFT from $name";
$message = "<html> <body>";
