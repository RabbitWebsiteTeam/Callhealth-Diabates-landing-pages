...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("phone" => $phone, "topic" => 'Diagnostics Vitamin D Call Back',"name"=>$name,"email"=> $email,"business"=>"Diagnostics Vitamin D");                                                                    
...
$source = "Diagnostics Vitamin D";


 $to= toMails;  

$subject = "Diagnostics Vitamin D from $name";
$message = "<html> <body>";
