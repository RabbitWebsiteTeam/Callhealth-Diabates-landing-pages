...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("phone" => $phone, "topic" => 'Diagnostics Vitamin_B12 Call Back',"name"=>$name,"email"=> $email,"business"=>"Diagnostics Vitamin_B12");                                                                    
...
$source = "Diagnostics Vitamin_B12";


 $to= toMails;  

$subject = "Diagnostics Vitamin_B12 from $name";
$message = "<html> <body>";
