...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("phone" => $phone, "topic" => 'Diagnostics URIC Call Back',"name"=>$name,"email"=> $email,"business"=>"Diagnostics URIC");                                                                    
...
$source = "Diagnostics URIC";


 $to= toMails;  

$subject = "Diagnostics URIC from $name";
$message = "<html> <body>";
