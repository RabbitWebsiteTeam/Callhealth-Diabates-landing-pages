...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("phone" => $phone, "topic" => 'Diagnostics TSH Call Back',"name"=>$name,"email"=> $email,"business"=>"Diagnostics TSH");                                                                    
...
$source = "Diagnostics TSH";


 $to= toMails;  

$subject = "Diagnostics TSH from $name";
$message = "<html> <body>";
