...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("phone" => $phone, "topic" => 'Diagnostics LIPID Call Back',"name"=>$name,"email"=> $email,"business"=>"Diagnostics LIPID");                                                                    
...
$source = "Diagnostics LIPID";


 $to= toMails;  

$subject = "Diagnostics LIPID from $name";
$message = "<html> <body>";
