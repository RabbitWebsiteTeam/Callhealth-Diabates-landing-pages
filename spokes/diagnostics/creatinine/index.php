...
<div class="col-xs-12 acont"> 
  ...
  <div class="panel panel-default clickable">
    ...
    <div id="collapseFour" class="panel-collapse collapse">
      <div class="panel-body">
	  <div class="col-xs-12 acont"> 
	 Creatinine levels may be higher than normal due to:
<ul><li>Block in urinary tract</li>
<li>Kidney damage or infection</li>
<li>Complications of Diabetes, Shock and Certain heart diseases</li>
...
<div class="panel panel-default clickable">
    ...
    <div id="collapseFive" class="panel-collapse collapse">
	  ...
	  <div class="col-xs-12 acont"> 
    <!-- 	  <ul>
    	  <li>No special preparation is required. Random blood sample is taken to do this test.</li>
          <li>Talk to your doctor about the medication you</li>
          </ul> -->
