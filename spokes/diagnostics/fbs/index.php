...
/* <![CDATA[ */
var google_conversion_id = 825634145;
...
<img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/825634145/?guid=ON&amp;script=0"/>
</div>
</noscript>

<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-63646674-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-63646674-1');
</script>
 ...
 <!-- 
  <div class="panel panel-default clickable">
    ...
    <div id="collapseFour" class="panel-collapse collapse">
	 ...
	 <tr>
	 <th style="text-align:center">GLUCOSE LEVEL</th>
	 <th style="text-align:center">INTERPRETATION</th>
	 <th style="text-align:center">ACTION</th>
	 <tr>
	 <tr>
	 <td>From 70 to 99 mg/dl</td>
	 <td>Normal fasting glucose</td>
	 <td>Repeat the test at least once in a year</td>
	 </tr>
	 <tr>
	 <td>From 100 to 125 mg/dl</td>
	 <td>Prediabetes (Levels are higher than normal but not enough to diagnose as diabetes)</td>
	 <td>Consult a doctor to discuss about the treatment plans available to delay or prevent development of diabetes</td>
	 </tr>
	 <tr>
	 <td>126 mg/dl and above on more than one testing occasion</td>
	 <td>Diabetes</td>
	 <td>Consult a doctor and take the medication and follow dietary, lifestyle changes as advised.</td>
	 </tr>
	 </table>
	 *Reference ranges and interpretations are as per the American Diabetic Association guidelines.
	  </div>
      </div>
    </div>
  </div>  
...
<div class="panel panel-default clickable">
	...
	<div class="row">
	<div class="col-xs-12 nor-pad">
      <h4 class="panel-title accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSix">
    ...
    <div id="collapseSix" class="panel-collapse collapse">
      <div class="panel-body">
	  <div class="col-xs-12 acont"> 
	  Early detection can help manage diabetes effectively and reduce the complications significantly
	  </div>
      </div>
    </div>
</div>
