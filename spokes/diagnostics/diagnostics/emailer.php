...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("source"=>$utm_source,"phone" => $phone, "topic" => 'Diagnostics Call Back',"name"=>$name,"email"=> $email,"business"=>"Diagnostics","device"=>$device);                                                                    
...
$subject = "Doctor's day wishes from $name";
$message = "<html> <body>";
