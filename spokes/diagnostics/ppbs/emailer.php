...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("phone" => $phone, "topic" => 'Diagnostics PPBS Call Back',"name"=>$name,"email"=> $email,"business"=>"Diagnostics PPBS");                                                                    
...
$source = "Diagnostics PPBS";


 $to= toMails;  

$subject = "Diagnostics PPBS from $name";
$message = "<html> <body>";
