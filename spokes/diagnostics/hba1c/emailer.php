...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("phone" => $phone, "topic" => 'Diagnostics HBA1C Call Back',"name"=>$name,"email"=> $email,"business"=>"Diagnostics HBA1C");                                                                    
...
$source = "Diagnostics HBA1C";


 $to= toMails;  

$subject = "Diagnostics HBA1C from $name";
$message = "<html> <body>";
