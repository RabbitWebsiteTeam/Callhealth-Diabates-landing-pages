	  ...
	  <div class="row" >
          <div class="col-md-6 col-xs-8 colpad">
           <div class="banncont">
		     ...
		     <div class="cont">Physio packages start at Rs.400 onwards</div>
		   </div>
          </div>
	  ...
	  <div class="col-sm-12 colpad">
          <div class="colpad">
            <div class="panel panel-default ">
                    ...
                    <div class="panel-body">
					<div class="phea">Get Physiotherapy @home</div>
                        <form role="form" id="indexFrm1" name="callhealth" action="emailer.php" method="post">
                            <fieldset>
...
<script>
 ...
 // validate indexFrm1 form on keyup and submit
    $("#indexFrm1").validate({
      rules: {
        name: {
          required: true,
