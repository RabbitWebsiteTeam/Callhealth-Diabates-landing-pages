...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("source"=>$utm_source,"phone" => $phone, "topic" => 'Physiotheraphy Call Back',"name"=>$name,"email"=> $email,"business"=>"Physiotheraphy","device"=>$device);                                                                    
...
$source = "Physiotheraphy";


 $to= toMails;  

$subject = "Physiotheraphy from $name";
$message = "<html> <body>";
