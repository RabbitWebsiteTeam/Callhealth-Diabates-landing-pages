...
<!-- Google Code for CallHealth - Medicines - Delhi - Landing Page  Conversion Page -->
<script type="text/javascript">
/* <![CDATA[ */
var google_conversion_id = 822044051;
var google_conversion_label = "io2MCJCwh3sQk8v9hwM";
...
<img height="1" width="1" style="border-style:none;" alt=""  src="//www.googleadservices.com/pagead/conversion/822044051/?label=io2MCJCwh3sQk8v9hwM&amp;guid=ON&amp;script=0"/>
</div>
</noscript> 
<!-- Facebook Pixel Code -->
...
<!-- End Google Tag Manager (noscript) -->
    <div id="content"  class="mobile-banner2">
      <div class="container">
        <!-- begin:latest -->
	  ...
	  <div class="row" >
          <div class="col-md-6 col-xs-8 colpad">
           <div class="banncont">
		     <div class="head">Pharmacy, now at your doorstep</div>
		     <div class="cont">at a discount of FLAT 30%</div>
		   </div>
          </div>
 ...
 <div class="container">
          ...
          <div class="col-md-3 col-xs-6">
            <div class="service-container">
              ...
              <div class="service-content">
                <p>Book your order by calling us @ 33 55 77 99 or by sending your prescription on whatsapp</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 col-xs-6">
            <div class="service-container">
              ...
              <div class="service-content">
                <p>Select your convenient date and time for delivery of medicines</p>
              </div>
            </div>
          </div>
		  ...
		  <div class="col-md-3 col-xs-6">
            <div class="service-container">
              ...
              <div class="service-content">
                <p>Free delivery of medicines with no additional charges </p>
              </div>
            </div>
          </div>
...
<div id="content1">
	...
	<center><div class="colorline"></div></center>
          ...
          <div class="col-md-3 col-xs-6 col-md-offset-3">
            <div class="service-container">
              <div class="service-icon1">
               <div class="simg"><img src="assets/images/nodelivery.png"/></div>
              </div>
              <div class="service-content">
          ...
          <div class="col-md-3 col-xs-6">
            <div class="service-container">
              <div class="service-icon1">
              <div class="simg"><img src="assets/images/payment.png"/></div>
              </div>
              <div class="service-content">
