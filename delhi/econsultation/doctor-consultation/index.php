    ...
    <div id="content" class="mobile-banner">
	  ...
	  <div class="row" >
          ...
          <div class="login-panel panel panel-default">
					...
					<div class="phea">Book an appointment today!</div>
	  ...
	  <div class="col-sm-12 colpad">
          <div class="colpad">
            <div class="panel panel-default ">
                    ...
                    <div class="panel-body">
                        <div class="phea">Book an appointment today!</div>
                         <form role="form" id="indexFrmMobi" name="callhealth" action="emailer.php" method="post" required>
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Name" name="name" id="name" type="text" autofocus>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Mobile no" name="phone" id="phone" type="text" pattern="^([0|\+[0-9]{1,5})?([1-9][0-9]{9})$" maxlength="10" required>
                                </div>
