...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("phone" => $phone, "topic" => 'Diagnostics Serum Electro Call Back',"name"=>$name,"email"=> $email,"business"=>"Diagnostics Serum Electro");                                                                    
...
$source = "Diagnostics Serum Electro";
...
$subject = "Diagnostics Serum Electro details from $name";
$message = "<html> <body>";
