...
<!-- 
  <div class="panel panel-default clickable">
    ...
    <div id="collapseFour" class="panel-collapse collapse">
      <div class="panel-body">
	  <div class="col-xs-12 acont"> 
	  Abnormal test results may mean you have an illness such as
	  <ul><li>Problems in the Kidney</li>
		<li>Infections in urine</li>
		<li>Uncontrolled diabetes</li>
		<li>Certain cancers</li>
		</ul>
       Consult a doctor for any further advice
	  </div>
      </div>
    </div>
  </div>  
...
<div class="panel panel-default clickable">
    ...
    <div id="collapseFive" class="panel-collapse collapse">
	  ...
	  <div class="col-xs-12 acont"> 
	 <!--  <ul>
	  <li>No preparation and fasting is required. Random blood sample is taken to do this test.</li>
      <li>'Clean-catch up' urine sample is preferred</li>
      <li>Do not stop any medication unless advised by your doctor</li>
      </ul> -->
