...
$date = date('Y-m-d h:i:s');
   ...
   $service_url = 'http://rabbitdigital.co.in/dashboard_api/api/leads';
    ...
    $setUrl  = setDataUrl;
    $data1 = array("phone" => $phone, "topic" => 'Diagnostics CUE Call Back',"name"=>$name,"email"=> $email,"business"=>"Diagnostics CUE");                                                                    
...
$subject = "Diagnostics CUE details from $name";
$message = "<html> <body>";
