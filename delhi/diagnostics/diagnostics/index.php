  ...
  <div class="container">
	  ...
	  <div class="row" >
          ...
          <div class="login-panel panel panel-default">
					...
					<div class="phea">Get Diagnostic Tests @home</div>
                         <form role="form" id="indexFrm" name="callhealth" action="emailer.php" method="post" required>
                            <fieldset>
 ...
 <div class="container">
          ...
          <div class="col-md-3 col-xs-6">
            <div class="service-container">
              ...
              <div class="service-content">
                <p>Book your test by filling up the form above</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 col-xs-6">
            <div class="service-container">
              ...
              <div class="service-content">
                <p>Mobile Health Officer visits your for sample collection</p>
              </div>
            </div>
          </div>
          <div class="col-md-2 col-xs-6">
            <div class="service-container">
              ...
              <div class="service-content">
                <p>Tests are analyzed at NABL approved labs and the reports are mailed to you</p>
              </div>
            </div>
          </div>
		  <div class="col-md-3 col-xs-6">
            <div class="service-container">
              ...
              <div class="service-content">
                <p>For tests requiring advanced equipment , use our assistance services to visit the nearest Diagnostic Centre</p>
              </div>
            </div>
          </div>
...
<div id="content1">
    ...
    <div class="row" id="section2">
	<div class="col-xs-12 nocolpad"><div class="down1">PACKAGES</div>
	<center><div class="colorline"></div></center>
	</div>
	</div>
