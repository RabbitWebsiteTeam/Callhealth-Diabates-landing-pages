...
<div class="col-xs-12 acont"> 
  ...
  <!-- <div class="panel panel-default clickable">
    ...
    <div id="collapseThree" class="panel-collapse collapse">
	  ...
	  <div class="col-xs-12 acont"> 
	  <ul>
	  <li>Low blood levels of Calcium usually mean one (or more) of the following
		<ul>
		<li>Disorders that affect absorption of nutrients from the intestines</li>
		<li>Problem with parathyroid</li>
      ...
      <li>High blood levels of calcium result from taking too many vitamin pills and other nutritional supplements.
		<ul>
		<li>Being on bed rest for a long time.</li>
		<li>Consuming too much calcium or vitamin D.</li>
