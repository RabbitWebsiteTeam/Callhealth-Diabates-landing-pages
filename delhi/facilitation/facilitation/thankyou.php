    ...
    <div id="content" class="mobile-banner">
	  ...
	  <div class="row" >
          <div class="col-md-6 col-xs-8 colpad">
           <div class="banncont">
		     <div class="head">Assistance for when your family needs it</div>
 ...
 <div class="container">
          ...
          <div class="col-md-3 col-xs-6">
            <div class="service-container">
              ...
              <div class="service-content">
                <p>Select the nearest diagnostic centre and schedule an appointment</p>
              </div>
            </div>
          </div>
          <div class="col-md-2 col-xs-6">
            <div class="service-container">
              ...
              <div class="service-content">
                <p>Get transport assistance from your residence at the scheduled date and time</p>
              </div>
            </div>
          </div>
		  <div class="col-md-3 col-xs-6">
            <div class="service-container">
              ...
              <div class="service-content">
                <p>Hassle free paperwork & expert handling of other formalities </p>
              </div>
            </div>
          </div>
